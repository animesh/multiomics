---
title: "Analysis of a cohort of Major Depressive Disorder (MDD) with RGCCA and MOFA"
author: "Jimmy Vandel & Arnaud Gloaguen"
date: "`r date()`"
output: 
  html_document:
    toc: true
...
==> There is a huge Sex effect. Openning on methods for Sex (or other batch) correction.
For now, we will only keep one of the two sex --> Females (higest number of samples)
...
* likelihoods: type of data per view (options are “gaussian”, “poisson”, “bernoulli”). 
